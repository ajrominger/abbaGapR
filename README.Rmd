...
R package *abbaGapR* (**A**mplicon-**b**ased **B**iodiversity **A**ssessment gap analysis in R) provides functions to download DNA sequence data from NCBI based on species names.
